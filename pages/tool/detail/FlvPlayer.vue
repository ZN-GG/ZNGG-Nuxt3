            ...
            <div class="container px-4 mx-auto">
                <div class="md:flex md:-mx-4 md:items-center py-8">
                    <div class="md:w-1/2 px-4">
                        <p class="text-2xl text-black">Flv在线播放器</p>
                    </div>
                </div>
            </div>
        </section>
        <section class="w-full container px-4 mx-auto py-12">
            <div class="video-player-box bg-black">
            ...
            <div class="flex flex-wrap justify-between my-2 items-center">
                ...
                <div class="flex flex-wrap w-full md:w-auto my-2 md:my-0 justify-between">
                    <div class="cursor-pointer py-1 px-4 bg-blue-500 text-gray-100 rounded md:ml-2" @click="clear()">清空</div>
                    <div class="cursor-pointer ml-2 py-1 px-4 bg-blue-500 text-gray-100 rounded" @click="load()">载入</div>
                    <div class="cursor-pointer ml-2 py-1 px-4 bg-blue-500 text-gray-100 rounded" @click="play()">开始</div>
                    <div class="cursor-pointer ml-2 py-1 px-4 bg-blue-500 text-gray-100 rounded" @click="pause()">暂停</div>
                    <div class="cursor-pointer ml-2 py-1 px-4 bg-blue-500 text-gray-100 rounded" @click="destroy()">销毁</div>
                </div>
            </div>
